...
$block_id = wp_unique_id( 'pressiq-accordion-' );
?>
        ...
        <div class="pressiq-accordion__item<?php echo $is_open ? ' is-active' : ''; ?>">
            <<?php echo esc_attr( $title_tag ); ?> class="pressiq-accordion__header-wrapper">
                <button type="button"
                    ...
                    <span class="pressiq-accordion__title"><?php echo esc_html( $item['title'] ?? '' ); ?></span>
                    <span class="pressiq-accordion__toggle pressiq-accordion__toggle--right">
                        <span class="pressiq-accordion__toggle-icon pressiq-accordion__toggle-icon--inactive" aria-hidden="true">+</span>
                        <span class="pressiq-accordion__toggle-icon pressiq-accordion__toggle-icon--active" aria-hidden="true">&minus;</span>
                    </span>
                </button>
